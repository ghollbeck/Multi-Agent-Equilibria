#!/usr/bin/env python3
"""
Internal script to generate architecture flowchart for the Fishery Game
"""
...
game_file = current_dir / "fishery_game.py"
...
def main():
    """Generate architecture flowchart for the Fishery Game"""
    if not game_file.exists():
